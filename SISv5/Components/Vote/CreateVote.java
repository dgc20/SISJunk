...
public class CreateVote {
	...
	private static final List<String> TYPES = new ArrayList<String>(
			Arrays.asList(new String[] { "Setting", "Alert", "Confirm", "Register" }));

	// summary for all incoming / outgoing messages
	private static final String incomingMessages = "IN\tConfirm|Setting:Kill||Alert:toSendVotes";
	...
	String CandidateID = kvList.getValue("CandidateID");
		...
		if(CandidateID != null) {
			System.out.println("Vote Registered For:" + CandidateID);
			KeyValueList alert = new KeyValueList();
			alert.putPair("Scope", "SIS");
			alert.putPair("MessageType", "Alert");
			alert.putPair("Sender", NAME);
			alert.putPair("Receiver", "Remote");
			alert.putPair("Nut", "Benis");
			encoder.sendMsg(alert);
		}
		if(CandidateList != null) {
			System.out.println("Candidates are: " + CandidateList);
		}
